    ...
    <div class="side-menu-area">
        ...
        <nav>
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="javascript:void(0)"><i class="icon-search"></i> <span>فعالیت ها</span> <i
                            class="fa fa-angle-left"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="javascript:void(0)"><i class="icon-layers"></i> <span>کالا های سیستم</span> <i
                            class="fa fa-angle-left"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="javascript:void(0)"><i class="ti-home"></i> <span>انبار ها</span> <i
                            class="fa fa-angle-left"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="javascript:void(0)"><i class="ti-truck"></i> <span>ورود کالا به انبار</span> <i
                            class="fa fa-angle-left"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="javascript:void(0)"><i class="ti-shopping-cart"></i> <span>مشتری ها</span> <i
                            class="fa fa-angle-left"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="javascript:void(0)"><i class="ti-shopping-cart-full"></i> <span>فروش فرآورده</span> <i
                            class="fa fa-angle-left"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="javascript:void(0)"><i class="ti-shopping-cart-full"></i> <span>سفارشات</span> <i
                            class="fa fa-angle-left"></i></a>
                    <ul class="treeview-menu">
