...
<head>
    ...
    <!-- Title -->
    <title>@yield('title',env('comp_name')) - سیستم اتوماسیون </title></head>
...
<div class="ecaps-page-wrapper">
    ...
    <div class="ecaps-sidemenu-area">
        ...
        <div class="ecaps-logo">
            <a href="index.html"><img class="desktop-logo" src="{{asset('img/core-img/logo.png')}}" alt="لوگوی دسک تاپ"> <img class="small-logo" src="{{asset('img/core-img/small-logo.png')}}" alt="آرم موبایل"></a>
        </div>
        ...
        <header class="top-header-area d-flex align-items-center justify-content-between">
            <div class="left-side-content-area d-flex align-items-center">
                ...
                <div class="mobile-logo mr-3 mr-sm-4">
                    <a href="index.html"><img src="{{ asset('img/core-img/small-logo.png') }}" alt="آرم موبایل"></a>
                </div>
                ...
                <ul class="left-side-navbar d-flex align-items-center">
                    <li class="nav-item dropdown ml-1 ml-sm-3">
                        <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">صفحات <i class="fa fa-angle-down"></i></button>
                        <!-- Dropdown Menu -->
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton6">

                            <a href="#" class="dropdown-item">- ایجاد گزارش </a>
                            <a href="#" class="dropdown-item">- مدیریت سفارشات </a>
                            <a href="#" class="dropdown-item">-  مشتریان </a>
                            <a href="#" class="dropdown-item">- عضو شوید</a>
                        </div>
                    </li>
                </ul>
                <!-- Left Side Nav -->
                <ul class="left-side-navbar d-flex align-items-center">
                    <li class="nav-item dropdown ml-1 ml-sm-3">
                        <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">برنامه ها <i class="fa fa-angle-down"></i></button>
                        <!-- Dropdown Menu -->
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
                            <a href="#" class="dropdown-item">- تجارت الکترونیک </a>
                            <a href="#" class="dropdown-item">- مخاطبان </a>
                            <a href="#" class="dropdown-item">- بازاریابی </a>
                            <a href="#" class="dropdown-item">- کمپین ها </a>
                            <a href="#" class="dropdown-item">مدیریت</a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="right-side-navbar d-flex align-items-center justify-content-end">
                ...
                <ul class="right-side-content d-flex align-items-center">
                    ...
                    <li class="hide-phone app-search">
                        <form role="search" class=""><input type="text" placeholder="جستجو..." class="form-control"> <button type="submit" class="mr-0"><i class="fa fa-search"></i></button></form>
                    </li>
                            ...
                            <div class="top-message-area">
                                ...
                                <div class="message-box" id="messageBox">
                                    <a href="#" class="dropdown-item">
                                        <img src="{{ asset('img/member-img/10.png') }}" alt="">
                                        <span class="message-text">
                                                <span>دوره آموزش ویدیوی 6 ساعته  </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="top-notifications-area">
                                ...
                                <div class="notifications-box" id="notificationsBox">
                                    <a href="#" class="dropdown-item"><i class="ti-face-smile bg-success"></i><span>لورم ایپسوم متن ساختگی  !</span></a>
                                    ...
                                    <a href="#" class="dropdown-item"><i class="ti-bolt bg-warning"></i><span>لورم ایپسوم متن ساختگی با تولید سادگی</span></a>
                                    <a href="#" class="dropdown-item"><i class="ti-face-smile bg-success"></i><span>لورم ایپسوم متن ساختگی با تولید سادگی</span></a>
                                    <a href="#" class="dropdown-item"><i class="zmdi zmdi-notifications-active bg-danger"></i><span>نام دامنه در روز سه شنبه منقضی می شود</span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <li class="nav-item dropdown">
                        <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('img/member-img/4.png') }}" alt=""></button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- User Profile Area -->
                            <div class="user-profile-area">
                                <div class="user-profile-heading">
                                    ...
                                    <div class="profile-img">
                                        <img class="chat-img mr-2" src="{{ asset('img/member-img/4.png') }}" alt="">
                                    </div>
                                    <!-- Profile Text -->
                                ...
                                <a href="{{ route('logout') }}" class="dropdown-item"><i class="ti-unlink profile-icon bg-warning" aria-hidden="true"></i> خروج از سیستم</a>
                            </div>
                        </div>
                    </li>
                </ul>
