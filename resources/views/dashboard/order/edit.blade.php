                        ...
                        <form method="post" action="{{ route('order.update', $order) }}" class="needs-validation"
                            ...
                            <div class="form-row">
                                    ...
                                    <select id="commodity_id" class="form-control" name="commodity_id" required>
                                        ...
                                        @foreach ($commodities as $commodity)
                                            <option value="{{ $commodity->id }}"
                                                    @if($order->commodity_id == $commodity->id )
                                                    selected
                                                @endif
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="price"  name="price" value="{{ $order->price }}" class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="deadline" value="{{ date('Y/m/d', strtotime($order->deadline)) }}"  id="deadline" class="form-control usage"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" id="amount"  min="1" value="{{ $order->commodity_amount }}"  name="commodity_amount" class="form-control"
