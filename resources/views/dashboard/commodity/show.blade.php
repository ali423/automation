                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="form-row col-md-12">
                            ...
                            @if(!empty($commodity->sales_price))
                                <div class="form-group col-md-4">
                                    <label for="exampleInputEmail111"> {{ __('fields.sales_price') }} هر {{ $commodity->unit ? $commodity->unit->symbol : '' }}</label>
                               ...
                               @elseif(!empty($commodity->purchase_price))
                                <div class="form-group col-md-4">
                                    <label for="exampleInputEmail111"> {{ __('fields.purchase_price') }} هر {{ $commodity->unit ? $commodity->unit->symbol : '' }}</label>
                        ...
                        <div class="form-row col-md-12">
                            ...
                            <div class="form-group col-md-3">
                                <label for="exampleInputEmail111"> {{ __('fields.warning_limit') }} ({{ $commodity->unit ? $commodity->unit->symbol : '' }})</label>
