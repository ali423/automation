        ...
        @foreach($used_materials as $used_material)
            <div id="inputFormRow" class="form-row shadow p-4 mb-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="number" step="0.00001" name="material_amount[]" class="form-control"
                           id="material_amount" value="{{ $used_material->pivot->amount }}"
                           placeholder="{{ __('fields.commodity.material_amount') }}" min="0.00001" required>
                    <div class="invalid-feedback">
        ...
        <div id="inputFormRow" class="form-row shadow p-4 mb-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="number" step="0.00001" name="material_amount[0]" class="form-control"
                       id="material_amount" placeholder="{{ __('fields.commodity.material_amount') }}" min="0.00001">
                <div class="invalid-feedback">
                    لطفاً {{ __('fields.commodity.material_amount') }} را وارد کنید
                </div>
            </div>
