    ...
    <div class="row">
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <h4 class="card-title">فروشنده جدید</h4>
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form method="post" action="{{ route('seller.store') }}" class="needs-validation" novalidate="">
                            @csrf
                            <div class="form-row">
                            ...
                            <button type="submit" class="btn btn-primary mr-2">ثبت فروشنده</button>
