        ...
        <div class="col-12 box-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- Pagination Controls --}}
                    <x-pagination-controls :paginator="$users" :options="$options" />
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    @else
                                        <td>سیستم</td>
                                    @endif
                                    <td><a href="{{ route('user.show', $user) }}"><i class="ti-more-alt font-24"></i></a>
                                    </td>
                                </tr>
                                @php($i++)
                            @endforeach
                ...
                <div class="card-footer">
                    <x-pagination-navigation :paginator="$users" />
                </div>
            </div> <!-- end card -->
        </div><!-- end col-->
    </div>
