                            ...
                            <div class="form-row col-md-12">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="inputState" class="form-control" name="status" required>
                                        ...
                                        <option value="inactive" @if ($user->status != 'active') selected @endif>غیر فعال
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">وضعیت نقش را انتخاب کنید.</div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary mr-2" onclick="return confirm('در صورت تایید تغییرات مورد نظر ثبت شود؟');">ویرایش</button>
