            ...
            <div class="card card-body">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form method="post" action="{{ route('importation_commodity.store') }}" class="needs-validation forms-sample" novalidate="">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="type" class="form-control" name="unit" required>
                                        ...
                                        @foreach( __('fields.commodity.units') as $key=>$value)
                                            <option value="{{$key}}" selected @if (old('unit') == $key) selected @endif
                                            >{{$value}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" min="1" name="commodity_amount" value="{{ old('commodity_amount') }}" class="form-control"
